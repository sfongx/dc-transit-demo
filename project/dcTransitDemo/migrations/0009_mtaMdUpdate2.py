# Generated by Django 2.0.8 on 2018-10-04 15:02
...
def update_mta_md_data(apps, schema_editor):
    # Get the VRE Agency
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('dcTransitDemo', '0008_vreUpdate2'),
    ]

    operations = [
        migrations.RunPython(update_mta_md_data)
    ]
