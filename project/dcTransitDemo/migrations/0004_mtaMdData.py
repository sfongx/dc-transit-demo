# Generated by Django 2.0.8 on 2018-09-25 03:15
...
def add_mta_md_data(apps, schema_editor):
    # Get the MTA Maryland Agency
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('dcTransitDemo', '0003_vreData'),
    ]

    operations = [
        migrations.RunPython(add_mta_md_data)
    ]
